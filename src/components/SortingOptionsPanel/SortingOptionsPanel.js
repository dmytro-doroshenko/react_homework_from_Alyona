...
import {SortingContext} from "../../context/index"
import {Button} from "../Button/Button";


  // Task 1
//    done: создать здесь функциональную компоненту SortingOptionsPanel
...
// Task 3
//   done: достать из SortingContext переменную sortType и передать ее как props под названием selectedSortType в компоненту BtnMenu
